_base_ = [
    '../_base_/models/FDASiameNet_mit-b0.py',
    '../common/standard_512x512_100e_levircd.py']
...
model = dict(
    ...
    backbone=dict(
        interaction_cfg=(
            None,
            dict(type='CSEFI_d', in_channels=128),
            dict(type='CFFM_e', channel=320),
            dict(type='CFFM_e', channel=512))
    ),
    decode_head=dict(
        num_classes=2,
